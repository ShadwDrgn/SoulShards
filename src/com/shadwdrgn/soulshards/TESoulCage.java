...
public class TESoulCage extends TileEntity implements IInventory {
	...
	public void updateEntity() {
		...
		if (count >= delay) {
			...
			for (int i = 0; i < mobCount; ++i) {
				 ...
				 */
				double x = xCoord
						+ (worldObj.rand.nextDouble() - worldObj.rand.nextDouble())
						* 4.0D;
	...
	private EntityLiving createMob() {
		...
		} else if (mobType.equals("Zombie")) { return new EntitySpawnedZombie(worldObj, special); }
		Entity entity = EntityList.createEntityByName(mobType, worldObj);
		if (entity instanceof EntityLiving) { return (EntityLiving)entity; }
		return null;
	}
